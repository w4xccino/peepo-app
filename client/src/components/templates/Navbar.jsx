...
<div>
  ...
  <div class="navbar bg-base-100">
    <div class="navbar-start w-20">   {/*Menu Amburguesa pi */}
      <div class="dropdown">
        <label tabindex="0" class="btn btn-ghost lg:hidden"> {/*Icono*/}
          <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
            <path stroke-linecap="round" stroke-linejoin="round" d="M4 6h16M4 12h16M4 18h16" />
          </svg>        
        </label>
  {/*Contenido del menu Amburguesa en listas no ordenadas UL */}
  ...
  {/*Menu de navegacion Principal PC*/}
    <div className="navbar-start hidden lg:flex ">
      <ul class="menu menu-horizontal p-0">
        <h1 class="btn btn-ghost normal-case text-xl">PeepoApp</h1>
          <li>
             <a href="/">
             <svg
               className="w-6 h-6"
