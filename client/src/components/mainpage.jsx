...
<div className="w-full min-h-screen bg-base-100 p-6">
    <div className="hero bg-base-20">
        <img src={require('../imagenes/logo.png')} className="max-w-sm rounded-lg shadow-2xl" alt="d"/>
    </div>
<br></br>
          ...
          <div className="flex justify-center">
            ...
            <p className="text-justify py-6">Bienvenido a PeepoApp comienze a buscar sus productos favoritos y llenarlos en el carrito de compras! Tenemos todo para ti :3
            Tenemos muchos productos de acuerdo asu necesidad en las siguientes categorias:</p>
            </div>
          </div>
          <div className="flex justify-center">
